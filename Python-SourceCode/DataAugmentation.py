...
class DataAugmentation(object):
                             ...
                             [
                                 ...
                                 [
                                     albu.MultiplicativeNoise(p=0.2,
                                                              ...
                                                              per_channel=True ,
                                                              elementwise=True),
                                     albu.Downscale(p=0.3, scale_min=0.5, scale_max=0.5) #decreases image quality bisher: p=0.8
                                 ], p=0.5)#,
    ...
    def showAugmentedImages(self):
        ...
        if self.data['frontalAndLateralView'] == True:
            ...
            self.tracker2 = IndexTracker(ax2, self.data['imageOtherView'], 'ImageOtherView', self.data['keypointsOtherView'])
