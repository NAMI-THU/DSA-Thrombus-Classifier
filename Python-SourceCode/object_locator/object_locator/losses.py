    ...
    def forward(self, prob_map, gt, orig_sizes):
        ...
        for b in range(batch_size):
            ...
            if n_gt_pts == 0:
                ...
                half_mean_pixel_factor = (torch.sum(p) / (2 * self.n_pixels)) * self.max_dist
                
                terms_1.append(half_mean_pixel_factor)                
                terms_2.append(half_mean_pixel_factor)
                continue
            ...
            #term_1 /= self.max_dist
            #term_2 /= self.max_dist
