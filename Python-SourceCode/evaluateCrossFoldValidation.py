...
if __name__ == "__main__":
    ...
    #Load Checkpoints:
    checkpoint_fold1_frontal = torch.load(PATH + "frontal_best_mcc_fold_1.pt")        
    checkpoint_fold1_lateral = torch.load(PATH + "lateral_best_mcc_fold_1.pt")
    checkpoint_fold2_frontal = torch.load(PATH + "frontal_best_mcc_fold_2.pt")        
    checkpoint_fold2_lateral = torch.load(PATH + "lateral_best_mcc_fold_2.pt")
    checkpoint_fold3_frontal = torch.load(PATH + "frontal_best_mcc_fold_3.pt")        
    checkpoint_fold3_lateral = torch.load(PATH + "lateral_best_mcc_fold_3.pt")
    #checkpoint_fold4_frontal = torch.load(PATH + "frontal_best_mcc_fold_4.pt")        
    #checkpoint_fold4_lateral = torch.load(PATH + "lateral_best_mcc_fold_4.pt")
    #checkpoint_fold5_frontal = torch.load(PATH + "frontal_best_mcc_fold_5.pt")        
    #checkpoint_fold5_lateral = torch.load(PATH + "lateral_best_mcc_fold_5.pt")
    
    

    print(checkpoint_fold1_frontal['acc'])
    print(checkpoint_fold1_lateral['acc'])
    print(checkpoint_fold2_frontal['acc'])
    print(checkpoint_fold2_lateral['acc'])
    print(checkpoint_fold3_frontal['acc'])
    print(checkpoint_fold3_lateral['acc'])
    #print(checkpoint_fold4_frontal['acc'])
    #print(checkpoint_fold4_lateral['acc'])
    #print(checkpoint_fold5_frontal['acc'])
    #print(checkpoint_fold5_lateral['acc'])
    ...
    for step, batch in enumerate(dataLoaderTest):
        ...
        #print(hasThrombus_frontal.item())
